...
- Connect button shows up sooner
- Reduced step size for volume increases
- Don't show template timestamps as green
- Adjusted timing for active timeout
- Hover preview for time and timestamp type

### Fixes

- Options page login not working
- Player login not working
- Fuzzy timestamp type search not working with spaces
- Chrome popup sizing/scrollbar
- Funimation black screen
- Funimation double pause
- Funimation volume set to 0
- Funimation don't replay the episode while loading the next
- Token refresh not working
- Duplicate timestamps created while using templates
- Skip to first timestamp when offset forward
