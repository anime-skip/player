...
/**
 * Return both sets of keyboard shortcuts, primary and secondary, in two forms:
 *
 * - `*ActionBindingMap` - writable map of the action to the key binding. Use on
 *   settings page to configure keyboard shortcuts.
 * - `*BindingActionsMap` - Read only map of key presses to the actions they
 *   trigger. Used to decide which action to trigger when pressing keys.
 */
