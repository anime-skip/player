export enum ActionTypes {
  ...
  INFER_TEMPLATE = '@root/INFER_TEMPLATE',
  CREATE_TEMPLATE = '@root/CREATE_TEMPLATE',
  UPDATE_TEMPLATE = '@root/UPDATE_TEMPLATE',
  UPDATE_TEMPLATE_TIMESTAMPS = '@root/UPDATE_TEMPLATE_TIMESTAMPS',
  DELETE_TEMPLATE = '@root/DELETE_TEMPLATE',
}
