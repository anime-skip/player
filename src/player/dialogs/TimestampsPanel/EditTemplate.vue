...
import TimestampPanelLayout from '@/player/components/TimestampPanelLayout.vue';
import { computed, defineComponent, ref } from 'vue';
import { useStore } from 'vuex';
import { Icon, Checkbox, TextInput, RaisedButton } from '@anime-skip/ui';
...
export default defineComponent({
  components: { TimestampPanelLayout, Icon, Checkbox, TextInput, RaisedButton },
  setup() {
